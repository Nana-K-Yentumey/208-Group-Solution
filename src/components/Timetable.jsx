...
const Timetable = () => {
  ...
  return (
    <table>
      <thead>
        <tr>
          <th style={{ border: '1px solid #ddd', padding: '8px' }}>Instrument</th>
      ...
      <tbody>
        {data.map((item, index) => (
          <tr key={index}>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>{item.instrument}</td>
            <td style={{ border: '1px solid #ddd', padding: '8px' }}>{item.sessions}</td>
